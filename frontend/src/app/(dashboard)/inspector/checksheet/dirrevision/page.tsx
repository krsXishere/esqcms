...
export default function DirRevisionPage() {
  return (
    <div className="space-y-6 text-black">
      {/* HEADER */}
      <div className="space-y-1">
        <p className="text-xs text-gray-500">Checksheet &gt; DIR Revision</p>
        <h1 className="text-xl font-semibold">DIR Revision Required</h1>
      ...
      <div className="bg-gray-100 rounded-xl shadow-sm p-5 space-y-3">
        ...
        <ul className="text-xs text-gray-600 list-disc pl-5 space-y-1">
          <li>Width – Measure 2 out of tolerance</li>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
        <div className="flex items-center gap-6">
          <h2 className="text-sm font-semibold">DIR Information</h2>
          <span className="text-xs text-gray-500">ID: DIR-2024-0013</span>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 text-sm">
          ...
          <div className="col-span-3">
            <label className="text-xs text-gray-500">Surat Jalan</label>
            <input
              disabled
              value="SJ/2025/12/003 - 2025-12-03"
              className="w-full mt-1 rounded-md border border-gray-200 px-3 py-2 bg-gray-100 text-gray-600"
            />
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            defaultValue="Re-measured items with new calibrated equipment. All values now within tolerance."
          />
        </div>
      </div>
