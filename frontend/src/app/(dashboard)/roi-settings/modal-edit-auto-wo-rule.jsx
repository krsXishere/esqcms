...
const ModalEditAutoWORule = ({ open, setOpen, rule, onSuccess }) => {
  ...
  useEffect(() => {
    if (open && rule) {
      setFormData({
        ...
        alarm_keyword: rule.alarm_keyword || "",
        metric_name: rule.metric_name || "",
        severity: rule.severity || "warning",
        area_id: rule.area_id || "",
        device_category_id: rule.device_category_id || "",
        wo_priority: rule.wo_priority || "high",
        wo_type: rule.wo_type || "corrective",
        sla_hours: rule.sla_hours || 24,
        auto_assign_to: rule.auto_assign_to || "",
        estimated_loss_per_hour: rule.estimated_loss_per_hour || 150000,
      });
      fetchDropdownData();
    }
  }, [open, rule]);
...
export default ModalEditAutoWORule;
