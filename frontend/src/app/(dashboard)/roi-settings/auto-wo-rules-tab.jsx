...
const formatCurrency = (value) => {
  if (value >= 1000000) {
    return `Rp ${(value / 1000000).toFixed(1)}M/hour`;
  } else if (value >= 1000) {
    return `Rp ${(value / 1000).toFixed(0)}K/hour`;
  }
  return `Rp ${value.toLocaleString()}/hour`;
};
        ...
        <CardContent sx={{ p: 2.5, display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="caption" color="textSecondary">
              ...
              a Work Order will be automatically created with the defined priority and SLA.
            </Typography>
          </Box>
        </CardContent>
      </Card>
                ...
                <TableBody>
                  {rules.map((rule) => (
                    <TableRow key={rule.id}>
                      ...
                      <TableCell>
                        <Typography variant="body2">{rule.sla_hours} hours</Typography>
                      </TableCell>
                      <TableCell>
