    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          <TbCurrencyDollar size={32} color="#10B981" />
          <Box>
        ...
        <CardContent sx={{ p: 2.5, display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="caption" color="textSecondary">
              ...
              the system will calculate: (1) Loss Avoided = Avoided Downtime × Loss/hour,
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell sx={{ fontWeight: 600 }} align="right">Downtime Loss/jam</TableCell>
                    <TableCell sx={{ fontWeight: 600 }} align="right">Technician/jam</TableCell>
      ...
      <Card
        sx={(theme) => ({
          ...
          bgcolor: theme.palette.mode === "dark" ? "#1E293B50" : "#F8FAFC",
        })}
      >
        <CardContent sx={{ p: 2.5 }}>
          ...
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2 }}>
            ...
            <Chip label="Downtime Loss: Rp 150,000/jam" size="small" variant="outlined" />
            <Chip label="Technician: Rp 50,000/jam" size="small" variant="outlined" />
...
export default EconomicConfigPage;
